...
session_start();
   ...
   $data = mysqli_query($conn, "SELECT * FROM laptop_lenovo");

   $query = "SELECT COUNT(*) as total FROM laptop_lenovo";
      ...
      <div class="modal-body">
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" name="nama_barang" id="nama_barang" class="form-control" autofocus require value="Laptop Lenovo" readonly>
            </div>
            <div class="row">
               <div class="col-md-6">
                    <div class="form-group">
