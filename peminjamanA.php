<?php 
   ...
   $data = mysqli_query($conn, "SELECT * FROM laptop_asus");
   
   $query = "SELECT COUNT(*) as total FROM laptop_asus";
        ...
        <div class="main_content">
            ...
            <table>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">no laptop : <?= $dt['no_laptop'] ?></p>
      ...
      <div class="modal-body">
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" name="nama_barang" id="nama_barang" class="form-control" autofocus require value="Laptop Asus" readonly>
            </div>
            <div class="row">
               <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nis" id="nis" class="form-control"  require placeholder="Masukan NIS anda" value="<?= $_SESSION['nis'] ?>" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
